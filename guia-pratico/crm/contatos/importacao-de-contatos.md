...
* **Apenas usuários com perfil de administrador** podem realizar a importação de contatos na Táime Pro .
...
<figure><img src="https://3176979156-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3HTAyLM7hzj1t6Nt4ii2%2Fuploads%2FsSGwbbHtZTXtQUiyBoLf%2F10.png?alt=media&#x26;token=adeae6e2-fbf4-4f5c-b641-3741ee471f86" alt=""><figcaption></figcaption></figure>
...
![](https://3176979156-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3HTAyLM7hzj1t6Nt4ii2%2Fuploads%2Fs8sn5XBuaAeZk8YpOFYk%2F0.png?alt=media)
...
**Passo 3**: Antes de concluir a importação, será necessário mapear as colunas da planilha com os campos correspondentes na plataforma Táime Pro. Se o sistema identificar colunas com nomes idênticos aos campos internos, ele sugerirá automaticamente o local de destino para os dados. Contudo, você terá a flexibilidade de alterar o campo de destino ou, se preferir, selecionar a opção **Não Importar**, para que o sistema ignore aquela coluna específica.
...
![](https://3176979156-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3HTAyLM7hzj1t6Nt4ii2%2Fuploads%2FHARoKE3QcRMeDmoGPoTc%2F1.png?alt=media)

**Passo 4**: Durante o processo de importação, o sistema pode identificar **conflitos entre os dados importados e aqueles já existentes na plataforma** Táime Pro, como **números duplicados** ou **contatos repetidos na planilha**. Quando isso ocorrer, você será notificado e deverá decidir qual ação tomar.
...
![](https://3176979156-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3HTAyLM7hzj1t6Nt4ii2%2Fuploads%2FDcH6LppvpuCUjIn5GfiC%2F2.png?alt=media)

**Nota**: marcando a opção **Arquivar contatos que não existem nesta planilha** o sistema vai arquivar todos aqueles contatos que já existam cadastrados na conta Táime Pro, mas que não estejam presentes na planilha.
...
![](https://3176979156-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3HTAyLM7hzj1t6Nt4ii2%2Fuploads%2FPjK5AFmbJlGIC9haEeRo%2F3.png?alt=media)
...
![](https://3176979156-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F3HTAyLM7hzj1t6Nt4ii2%2Fuploads%2FiVy77Z9H3QW387LQJq1s%2F4.png?alt=media)

**Considerações Adicionais**:

* Etiquetas na planilha que **não existam na plataforma Táime Pro serão criadas automaticamente durante a importação.**
